...
@extend_schema_view(
    ...
    destroy=extend_schema(summary="Vô hiệu hóa danh mục"),
)
class MaterialCategoryViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        qs = MaterialCategory.objects.filter(is_active=True)
...
@extend_schema_view(
    ...
    destroy=extend_schema(summary="Vô hiệu hóa đơn vị"),
...
class UnitViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return Unit.objects.filter(is_active=True).order_by("code")
...
@extend_schema_view(
    ...
    destroy=extend_schema(summary="Vô hiệu hóa quy đổi"),
)
class UnitConversionViewSet(
    ...
    def get_queryset(self):
        return UnitConversion.objects.filter(is_active=True).select_related(
...
@extend_schema_view(
    ...
    destroy=extend_schema(summary="Vô hiệu hóa vật tư"),
)
class MaterialViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        qs = Material.objects.filter(is_active=True).select_related("category", "unit")
